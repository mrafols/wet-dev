...
<div class="contentContainer">
  ...
  <div>
    ...
    <h3><span class="inputRequirement" style="float: right;"><?php echo FORM_REQUIRED_INFORMATION; ?></span><?php echo FORM_TITLE_CUSTOMER_DETAILS; ?></h3>
  </div>
  ...
  <div class="contentInfoText">
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('from_name', '', 'class="input"'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('from_email_address', '', 'class="input"'); ?></td>
      </tr>
    </table>
  </div>
  ...
  <div class="contentInfoText">
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('to_name', '', 'class="input"') . '&nbsp;<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</span>'; ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo FORM_FIELD_FRIEND_EMAIL; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('to_email_address', '', 'class="input"') . '&nbsp;<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>'; ?></td>
      </tr>
    </table>
  </div>
  ...
  <div class="buttonSet">
    <span class="buttonAction"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$HTTP_GET_VARS['products_id'])); ?><?php echo tep_draw_button_bottom();?></span>

    <div class="fl_right" align="right"><?php echo tep_draw_button2_top();?><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?><?php echo tep_draw_button2_bottom();?></div>
  </div>
