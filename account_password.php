...
<div class="contentContainer">
  ...
  <div>
    ...
    <h3><span class="inputRequirement" style="float: right;"><?php echo FORM_REQUIRED_INFORMATION; ?></span><?php echo MY_PASSWORD_TITLE; ?></h3>
  </div>
  ...
  <div class="contentInfoText">
    <table border="0" width="100%" cellspacing="2" cellpadding="2">
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_password_field('password_current', '', ' class="input"') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CURRENT_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CURRENT_TEXT . '</span>': ''); ?></td>
      </tr>
      <tr> 
        <td class="fieldKey"><?php echo ENTRY_PASSWORD_NEW; ?></td>
        <td class="fieldValue"><?php echo tep_draw_password_field('password_new', '', ' class="input"') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_NEW_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_NEW_TEXT . '</span>': ''); ?></td>
      </tr>
      <tr> 
        <td class="fieldKey"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></td>
        <td class="fieldValue"><?php echo tep_draw_password_field('password_confirmation', '', ' class="input"') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>': ''); ?></td>
      </tr>
    </table>
  </div>
