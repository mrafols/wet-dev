...
*/
  ...
  $current_page = FILENAME_ADVANCED_SEARCH_RESULT;
  $error = false;
...
?>
  ...
  <div class="buttonSet extra2">
    <span class="fl_right"><?php echo tep_draw_button2_top();?><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false)); ?><?php echo tep_draw_button2_bottom();?></span>
  </div>
<br />
