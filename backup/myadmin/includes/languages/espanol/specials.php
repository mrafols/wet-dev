...
define('TEXT_SPECIALS_PRICE_TIP', '<strong>Notas:</strong><ul><li>Puedes introducir un porcentaje de reducci&oacute;n del precio del producto, por ejemplo: <strong>20%</strong></li><li>Si por el contrario, introduces un precio de oferta debes de usar el punto como separador decimal \'.\' (punto decimal), por ejemplo: <strong>49.99</strong></li><li>Deja la fecha de caducidad vac&iacute;a si no quieres caducidad</li></ul>');
