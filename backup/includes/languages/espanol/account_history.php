...
define('NAVBAR_TITLE_2', 'Hist&oacute;rico');

define('HEADING_TITLE', 'Historial de Pedidos');

define('TEXT_ORDER_NUMBER', 'N&uacute;mero de Pedido:');
...
define('TEXT_NO_PURCHASES', 'No ha realizado ning&uacute;n pedido a&uacute;n.');
?>