...
define('BOX_CATALOG_FEATURED_PRODUCTS', '<b class="add_by_seaman">Featured Products</b>');
//FP: end
/* Optional Related Products (ORP) */
        define('BOX_CATALOG_CATEGORIES_RELATED_PRODUCTS', '<b class="add_by_seaman">Related Products</b>');
...
//ORP: end 
 define('BOX_HEADING_PAGES', 'Pages');
 define('BOX_HEADING_SETTING', 'Setting');
  
 define('BOX_CATALOG_TAGS', '<b class="add_by_seaman">Tags</b>');
