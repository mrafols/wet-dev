...
<div class="contentContainer">
  ...
  <div class="contentInfoText">
    <div class="" style="float:right; width:auto; margin-left:17px;">
      <h3 class="first_h3"><?php echo PRIMARY_ADDRESS_TITLE; ?></h3>
...
?>
    ...
    <div>
      <span style="float: right;"><?php echo tep_draw_button2_top();?><?php echo tep_draw_button(SMALL_IMAGE_BUTTON_EDIT, 'document', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL')) .  tep_draw_button2_bottom().'&nbsp;&nbsp;'.tep_draw_button2_top() . tep_draw_button(SMALL_IMAGE_BUTTON_DELETE, 'trash', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL')); ?><?php echo tep_draw_button2_bottom();?></span>
...
?>
    <div class="fl_right" align="right"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_ADD_ADDRESS, 'home', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL'), 'primary'); ?><?php echo tep_draw_button_bottom();?></div>
  </div>
