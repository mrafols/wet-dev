...
?>
  ...
  <div class="contentInfoText">
    <div class="" style="float:right; width:auto; margin-left:17px;">
      <h3 class="first_h3"><?php echo TITLE_PAYMENT_ADDRESS; ?></h3>
...
?>
  <div class="buttonSet">
    <div class="fl_right" align="right"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL')); ?><?php echo tep_draw_button_bottom();?></div>
  </div>
