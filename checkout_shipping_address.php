...
?>
  ...
  <div class="contentInfoText">
  <div class="contentText"><?php echo TEXT_CREATE_NEW_SHIPPING_ADDRESS; ?></div>
...
?>
  ...
  <div class="buttonSet">
    ...
    <div class="fl_right" align="right"><?php echo tep_draw_button_top();?><?php echo tep_draw_hidden_field('action', 'submit') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?><?php echo tep_draw_button_bottom();?></div>
  </div>
...
?>
  <div class="buttonSet">
    <div class="fl_right" align="right"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL')); ?><?php echo tep_draw_button_bottom();?></div>
  </div>
