...
*/
  ...
  define('PIC_MARG_W2','0'); //
  define('PIC_MARG_H2','0'); //

  define('PIC_MARG_W4','0'); //
  define('PIC_MARG_H4','0'); //
  define('PIC_MARG_T4','0'); //
  define('PIC_MARG_R4','0'); //
  define('PIC_MARG_B4','0'); //
  define('PIC_MARG_L4','0'); // 

  define('PIC_MARG_W44','0'); //
  define('PIC_MARG_H44','0'); //
