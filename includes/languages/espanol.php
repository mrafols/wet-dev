...
/* ## add by Seaman ####################################  */
define('ITEM_INFORMATION_PRIVACY', 'Aviso de Privacidad');
...
define('PRICE', 'Precio:&nbsp;&nbsp;');
define('PRICE2', 'Precio anterior:&nbsp;&nbsp;');
define('BACK_TO_TOP', 'Inicio');
define('SEE_ALL', 'Ver todos');
...
define('IMAGE_BUTTON_RP_BUY_NOW', 'Comprar Ahora');
//ORP: end 
/* ## add by Seaman ####################################  */
?>
