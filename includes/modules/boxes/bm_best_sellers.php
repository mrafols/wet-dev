  ...
  class bm_best_sellers {
    ...
    function bm_best_sellers() {
      ...
      if ( defined('MODULE_BOXES_BEST_SELLERS_STATUS') ) {
		...
		//		}else{
    //    $this->group = ((MODULE_BOXES_BEST_SELLERS_CONTENT_PLACEMENT == 'Right Column') ? 'boxes_column_left' : 'boxes_column_right');
		//		}
      }
    }
...
/* ********************************* */			 
			$name_prod = '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '" rel="'.DIR_WS_IMAGES . $best_sellers['products_image'].'">' . $best_sellers['products_name'] . '</a>';
       ...
       //   $bestsellers_list .= '';
          ...
          $data = '<div class="infoBoxWrapper list">' . tep_draw_box_wrapper_top() . "\n" .
                  ...
                  '  		<div class="infoBoxContents">' . tep_draw_box_content_top() . '<ul class="bestsellers">' . $bestsellers_list . '</ul>' . "\n".
									//'' .tep_draw_button2_top() . '<a href="'.tep_href_link(FILENAME_TOPSELLERS_PRODUCTS).'" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">'.  SEE_ALL .'</span></a>' . tep_draw_button2_bottom().'' . "\n".
