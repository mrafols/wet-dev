...
// display counts
    ...
    function getData() {
      ...
      $data = '<div class="infoBoxWrapper list dark">' . tep_draw_box_wrapper_top() . 
              '  <div class="infoBoxHeading none">' . tep_draw_box_title_top() . MODULE_BOXES_CATEGORIES_BOX_TITLE . tep_draw_box_title_bottom() . '</div>' .
