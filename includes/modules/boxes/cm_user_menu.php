...
*/
  ...
  class cm_user_menu {
    ...
    function execute() {
      ...
      $data = '	<div class="box_header_user_menu">
				  <ul class="user_menu">'.
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_BOXES_USER_MENU_SORT_ORDER', '6030', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
