...
*/
  ...
  class cm_currencies {
    ...
    //   $this->group = ((MODULE_BOXES_CURRENCIES_HEADER_FOOTER_CONTENT_PLACEMENT == 'Header Block') ? 'boxes_header' : 'boxes_above_footer');
      }
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Content Placement', 'MODULE_BOXES_CURRENCIES_HEADER_FOOTER_CONTENT_PLACEMENT', 'Header Block', 'Should the module be loaded in the Header Block?', '6', '1', 'tep_cfg_select_option(array(\'Header Block\'), ', now())");
