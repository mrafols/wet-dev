  ...
  class bm_specials {
    ...
    function execute() {
      ...
      if (!isset($HTTP_GET_VARS['products_id'])) {
		...
		$sp_price_1 = '<span class="productSpecialPrice" style="float:right;">' . $currencies->display_price($random_product['specials_new_products_price'], tep_get_tax_rate($random_product['products_tax_class_id'])).'</span>';
