...
// retreive the last x products purchased
        ...
        if (tep_db_num_rows($orders_query)) {
          ...
          $customer_orders_string = '<table border="0" width="100%" cellspacing="0" cellpadding="0" class="order_history">';
          ...
          $data = '<div class="infoBoxWrapper">' . tep_draw_box_wrapper_top() .
                  '  <div class="infoBoxHeading">' . tep_draw_box_title_top() . MODULE_BOXES_ORDER_HISTORY_BOX_TITLE . tep_draw_box_title_bottom() . '</div>' .
                  '  <div class="infoBoxContents">' . tep_draw_box_content_top()  . $customer_orders_string . tep_draw_box_content_bottom() . '</div>' . 
