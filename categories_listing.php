...
<?php if ($image2 !=''){?><div class="title_pic"><?php echo tep_image(DIR_WS_IMAGES . $image2, $catname, '', HEADING_IMAGE_HEIGHT); ?></div><?php } ?><h1><?php echo $catname; ?></h1>
...
// optional Product List Filter
    if (PRODUCT_LIST_FILTER > 0) {
      ...
      if (tep_db_num_rows($filterlist_query) > 1) {
        echo  tep_draw_form('filter', tep_href_link( FILENAME_DEFAULT ), 'get') . '<div class="show"><div>' . TEXT_SHOW . '&nbsp;';
        if (isset($HTTP_GET_VARS['manufacturers_id'])) {
        ...
        echo tep_hide_session_id() . '</div><ul class="row_table"><li class="row_view">'.tep_image(DIR_WS_ICONS . 'row.png', '').'</li><li class="table_view">'.tep_image(DIR_WS_ICONS . 'table.png', '').'</li></ul></div></form>' . "\n";
