...
<div class="contentInfoText" style="position:relative; height:160px;">
  ...
  <div class="buttonSet btn_position">
    <span class="buttonAction"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL')); ?><?php echo tep_draw_button_bottom();?></span>
  </div>
...
<div class="contentInfoText" style="position:relative; height:160px;">
    ...
    <p class="small_title"><?php echo TEXT_RETURNING_CUSTOMER; ?></p>

    <?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL'), 'post', '', true); ?>

    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr>
        <td class="fieldKey"><div class="crosspiece100"></div><?php echo ENTRY_EMAIL_ADDRESS; ?></td>
        <td class="fieldValue" width="100%"><?php echo tep_draw_input_field('email_address', '', 'class="input"'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_PASSWORD; ?></td>
        <td class="fieldValue"><?php echo tep_draw_password_field('password', '', 'class="input"'); ?></td>
      </tr>
    </table>
  ...
  <div class="buttonSet btn_position">
    ...
    <p class="forgotten"><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></p>
