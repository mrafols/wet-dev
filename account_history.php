...
?>
  ...
  <h3><?php echo TEXT_ORDER_NUMBER . ' ' . $history['orders_id'] . ' <span class="contentText">(' . $history['orders_status_name'] . ')</span>'; ?></h3>
  ...
  <div class="contentInfoText">
    <table border="0" width="100%" cellspacing="2" cellpadding="2">
      <tr>
        ...
        <td width="20%" align="right"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(SMALL_IMAGE_BUTTON_VIEW, 'document', tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'order_id=' . $history['orders_id'], 'SSL'), 'primary'); ?><?php echo tep_draw_button_bottom();?></span></td>
     </tr>
    </table>
  </div>
...
<?php echo tep_draw_result2_top(); ?> 
        ...
        <div class="cl_both result_bottom_padd ofh">
        	<div class="fl_left result_left"><?php echo $history_split->display_count(TEXT_DISPLAY_NUMBER_OF_ORDERS); ?></div>
            <div class="fl_right result_right"><?php echo TEXT_RESULT_PAGE . ' ' . $history_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></div>
        </div>
