...
<div class="contentContainer">
  ...
  <div class="contentInfoText">
    ...
    <div class="buttonSet">
      ...
      <span style="float: right;"><?php echo tep_draw_button_top();?><?php echo tep_draw_button(IMAGE_BUTTON_SEARCH, 'search', null, 'primary'); ?><?php echo tep_draw_button_bottom();?></span>
    </div>
...
<script type="text/javascript">
  ...
  <div class="contentInfoText">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td class="fieldKey"><div class="crosspiece100"></div><?php echo ENTRY_CATEGORIES; ?></td>
        <td class="fieldValue" width="100%"><?php echo tep_draw_pull_down_menu('categories_id', tep_get_categories(array(array('id' => '', 'text' => TEXT_ALL_CATEGORIES))), '', ' class="input"'); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_pull_down_menu('manufacturers_id', tep_get_manufacturers(array(array('id' => '', 'text' => TEXT_ALL_MANUFACTURERS))), '', ' class="input"'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_PRICE_FROM; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('pfrom', '', 'class="input"'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_PRICE_TO; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('pto', '', 'class="input"'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey "><?php echo ENTRY_DATE_FROM; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('dfrom', '', 'id="dfrom" class="input"'); ?><script type="text/javascript">jQuery(document).ready(function () {$('#dfrom').datepicker({dateFormat: '<?php echo JQUERY_DATEPICKER_FORMAT; ?>', changeMonth: true, changeYear: true, yearRange: '-10:+0'});});</script></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_DATE_TO; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('dto', '', 'id="dto" class="input"'); ?><script type="text/javascript">jQuery(document).ready(function () {$('#dto').datepicker({dateFormat: '<?php echo JQUERY_DATEPICKER_FORMAT; ?>', changeMonth: true, changeYear: true, yearRange: '-10:+0'});});</script></td>
      </tr>
    </table>
	</div>
</div>
