...
<div class="ofh">
  <h1 class="fl_left"><?php echo $products_name; ?></h1>
	<h1 class="fl_right"><?php echo $products_price; ?></h1>  
</div>
...
?>
  ...
  <div class="contentInfoText">
    <table border="0" cellspacing="0" cellpadding="2" class="table">
      <tr>
        <td class="fieldKey"><div class="crosspiece85"></div><?php echo SUB_TITLE_FROM; ?></td>
        <td class="fieldValue" width="100%"><?php echo tep_output_string_protected($customer['customers_firstname'] . ' ' . $customer['customers_lastname']); ?></td>
      </tr>
      <tr>
  ...
  <div class="buttonSet">
    <span class="buttonAction"><?php echo tep_draw_button2_top();?><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params(array('reviews_id', 'action')))); ?><?php echo tep_draw_button2_bottom();?></span>
